...
landsatC2L2LST.batch.fun <- function(input_dir      = "F:/rp_2021_uhi_kyiv/data_raw/Landsat_C2L2_thermal/",
...
#---- CALCULATE LANDSAT 8 LST ----
    
    # process Landsat 8 UTM36 LST ----
    
    print("Starting Landsat 8 UTM36 files")
    
    for (i in 1:length(t10_836_file)){
        # read rasters
        ...
        print(paste("Processed", i, "out of", length(t10_836_file)))
    ...
    # process Landsat 8 UTM35 LST ----
    
    print("Starting Landsat 8 UTM35 files")
    
    for (i in 1:length(t10_835_file)){
        # read rasters
        ...
        print(paste("Processed", i, "out of", length(t10_835_file)))
        
    }
    
    print("Completed Landsat 8 UTM35 files")
    
#---- CALCULATE LANDSAT 4-7 LST ----
    
    # process Landsat 4-7 UTM36 LST ----
    
    print("Starting Landsat 4-7 UTM36 files")
    
    for (i in 1:length(t6_45736_file)){
        # read rasters
        ...
        print(paste("Processed", i, "out of", length(t6_45736_file)))
    ...
    # process Landsat 4-7 UTM35 LST ----
    
    print("Starting Landsat 4-7 UTM35 files")
    
    for (i in 1:length(t6_45735_file)){
      # read rasters
      ...
      print(paste("Processed", i, "out of", length(t6_45735_file)))
      
    }
    
    print("Completed Landsat 4-7 UTM35 files")
